...
from app.forms import LoginForm, RegistrationForm, EditProfileForm, PostForm, ResetPasswordRequestForm, ResetPasswordRequestForm, ResetPasswordForm
...
def follow(username):
    ...
    if user == current_user:
        flash(_('You cannot folow yourself!'))
